...
import { Mail, Lock, ArrowRight, ShieldCheck, Apple } from 'lucide-react'
        ...
        <div className="min-h-screen bg-[#020202] flex items-center justify-center p-4 relative overflow-hidden font-sans">
            ...
            >
                <div className="grid lg:grid-cols-2 gap-0 bg-white/2 backdrop-blur-3xl border border-white/10 rounded-[3rem] overflow-hidden shadow-[0_60px_100px_-20px_rgba(0,0,0,0.9)]">
                    ...
                    <div className="hidden lg:flex flex-col justify-between p-12 bg-linear-to-br from-brand-accent/10 to-transparent border-r border-white/10">
                        <div>
                            ...
                            <h2 className="text-5xl font-black text-white leading-tight mb-6">
                                <span className="bg-linear-to-r from-white to-gray-500 bg-clip-text text-transparent">Welcome</span><br />
                                <span className="text-brand-accent underline decoration-brand-accent/20 underline-offset-8 italic">Back Elite</span>
                            </h2>
                            <p className="text-gray-400 text-lg font-medium leading-relaxed max-w-sm">
                                Access your personalized training gear and resume your performance journey.
                            </p>
                        </div>
                    ...
                    <div className="p-10 md:p-14">
                        ...
                        <div className="mb-10 text-center lg:text-left">
                            <h3 className="text-3xl font-black text-white tracking-tight mb-2">Login</h3>
                            <p className="text-gray-500 font-bold uppercase text-[10px] tracking-[0.3em]">Welcome back athlete</p>
                        </div>
                        ...
                        <form className="space-y-5" onSubmit={handleLogin}>
                            ...
                            <div className="space-y-2">
                                <div className="flex justify-between items-center">
                                    ...
                                    <Link href="/forgot-password" className="text-[10px] font-black text-brand-accent uppercase tracking-widest hover:underline decoration-2 underline-offset-4 transition-all">Forgot?</Link>
                                </div>
                                <div className="relative group">
                            ...
                            <button className="w-full bg-brand-accent hover:bg-white text-black font-black uppercase text-xs tracking-[0.3em] py-5 rounded-2xl transition-all shadow-[0_20px_40px_-10px_rgba(8,203,0,0.3)] hover:scale-[1.02] active:scale-95 cursor-pointer mt-4">
                                Login
                            </button>
                        </form>
                        ...
                        <div className="grid grid-cols-2 gap-3">
                            <button
                                ...
                                className="flex items-center justify-center p-4 bg-white/3 border border-white/5 rounded-2xl hover:bg-white/8 hover:border-white/10 transition-all cursor-pointer"
                            >
                        ...
                        <p className="text-center text-gray-500 text-[11px] font-bold mt-10 uppercase tracking-widest">
                            New Athlete? {' '}
                            <Link href="/signup" className="text-white hover:text-brand-accent transition-colors underline decoration-brand-accent/40 underline-offset-4">Create Account</Link>
                        </p>
                    </div>
                </div>
            </motion.div>
